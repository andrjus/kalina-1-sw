...
#define swt_CONFIG_CURRENT_MIN -K1_MOTOR_CURRENT_A_TO_PP(70)
#define swt_CONFIG_CURRENT_MAX K1_MOTOR_CURRENT_A_TO_PP(70)

#define BURST_PANICS_ACWC_OVERCURRENT_ENABLED 0
#if BURST_PANICS_ACWC_OVERCURRENT_ENABLED == 1
#define motor_PANICS_ACWC_OWERCURRENT_PP K1_MOTOR_CURRENT_A_TO_PP(100)
#define motor_PANICS_ACWC_OWERPOWER_PP K1_MOTOR_CURRENT_A_TO_PP(70)
#define motor_PANICS_ACWC_NORMPOWER_PP K1_MOTOR_CURRENT_A_TO_PP(50)

...
#define swt_CONFIG_GAIN_PROP 15000
#define swt_CONFIG_GAIN_MODEL 350
...
#define swt_CONFIG_CURRENT_MIN -K1_MOTOR_CURRENT_MAMPER_TO_PP(30)
#define swt_CONFIG_CURRENT_MAX K1_MOTOR_CURRENT_MAMPER_TO_PP(30)

//Ipp=100pp -> 2*Upp = 178.0 mV -> I = 2*Upp/20= 8.9A -> Ipp/I = 100/8.9
#define K1_MOTOR_CURRENT_MAMPER_TO_PP_GAIN_15 ((burst_long_signal_t)(32767.*100./8.9 + 16384.))
#define K1_MOTOR_CURRENT_PP_TO_MAMPER_GAIN_15 ((burst_long_signal_t)(32767.*8.9/100. + 16384.))

#define BURST_PANICS_ACWC_OVERCURRENT_ENABLED 1
#if BURST_PANICS_ACWC_OVERCURRENT_ENABLED == 1
#define motor_PANICS_ACWC_OWERCURRENT_PP K1_MOTOR_CURRENT_MAMPER_TO_PP(15)
#define motor_PANICS_ACWC_OWERPOWER_PP K1_MOTOR_CURRENT_MAMPER_TO_PP(10)
